...
namespace Celemp
{
    public partial class Player
    {
        public void Cmd_Ship_Attack_Ship(Command cmd)
        {
            ...
            galaxy.players[victim.owner].cmd_results.Add($"{ship.DisplayNumber()} attacked your ship {victim.DisplayNumber()} with {shots} shots");
        ...
        public void Cmd_Ship_Attack_PDU(Command cmd)
        {
            ...
            galaxy.players[plan.owner].cmd_results.Add($"{ship.DisplayNumber()} fired on your PDUs around Planet {plan.DisplayNumber()} destroying {destroyed}; receiving {received} hits in return");
        }
        ...
        public void Cmd_Ship_Attack_Industry(Command cmd)
        {
            ...
            galaxy.players[plan.owner].cmd_results.Add($"{ship.DisplayNumber()} fired on your Industry on {plan.DisplayNumber()} destroying {destroyed}");
        ...
        public void Cmd_Ship_Attack_Mine(Command cmd)
        {
            ...
            galaxy.players[plan.owner].cmd_results.Add($"{ship.DisplayNumber()} fired on your Mines R{oreType} on {plan.DisplayNumber()} destroying {destroyed} and {ore_destroyed} ore");
        ...
        public void Cmd_Ship_Attack_Spacmine(Command cmd)
        {
            ...
            galaxy.players[plan.owner].cmd_results.Add($"{ship.DisplayNumber()} fired on your spacemines on {plan.DisplayNumber()} destroying {destroyed}");
        ...
        public void Cmd_Ship_Attack_Ore(Command cmd)
        {
            ...
            galaxy.players[plan.owner].cmd_results.Add($"{ship.DisplayNumber()} fired on your Ore R{oreType} on {plan.DisplayNumber()} destroying {destroyed} ore");
        ...
        public void Cmd_Planet_Attack_Ship(Command cmd)
        {
            ...
            galaxy.players[ship.owner].cmd_results.Add($"{plan.DisplayNumber()} fired on your ship {ship.DisplayNumber()} with {amount} PDUs inflicting {received} damage  ");
        }
    }
}